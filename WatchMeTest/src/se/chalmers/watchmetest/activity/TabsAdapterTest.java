...
public class TabsAdapterTest extends ActivityInstrumentationTestCase2<MainActivity> {
	...
	public void testAddTab() {
		...
		//TODO: Smelly test? 
		// better getting empty action bar or clearing action bar from mainactivity?
		...
		assertTrue(tabsAdapter.getCount() == 3);
	...
	public void testOnTabSelected() {
		...
		//TODO: possible change if less smelly: add getTabs() in TabsAdapter and 
		// use assertTrue(viewPager.getCurrentItem() == tabsAdapter.getTabs().indexOf(tab2))
